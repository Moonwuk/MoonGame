...
export const en: Record<string, string> = {
  ...
  'Сессия': 'Session',
  'Сетевой чат ещё не подключён — используйте пинги 📍': "Network chat isn't wired up yet — use pings 📍",
  ...
  'переговоры с другими игроками — позже (нужен сервер)': 'negotiating with other players — later (needs a server)',
  ...
  'Очередь приказов{steps}{total}': 'Order queue{steps}{total}',
  ' · {n} шаг.': ' · {n} step(s)',
  ...
  '▶ шаг исполняется: флот в пути': '▶ step in progress: fleet en route',
  '⏸ бой — план ждёт исхода': '⏸ battle — plan awaits the outcome',
  '⏸ выжидаем ещё ~{h}': '⏸ waiting ~{h} more',
  '▶ следующий шаг на очереди': '▶ next step is queued',
  '➕ строю план: тапайте миры — каждый тап добавляет переход': '➕ building a plan: tap worlds — each tap adds a leg',
  '➕ шаг: ⚔ штурм по прибытии': '➕ step: ⚔ assault on arrival',
  '➕ шаг: ▲ погрузка гарнизона': '➕ step: ▲ load garrison',
  '➕ шаг: ▼ выгрузка десанта': '➕ step: ▼ unload troops',
  '➕ шаг: ☄ обстрел с орбиты': '➕ step: ☄ bombard from orbit',
  '➕ шаг: ⏸ ждать {n}ч': '➕ step: ⏸ wait {n}h',
  '➕ шаг {n}: → {to}{tail}': '➕ step {n}: → {to}{tail}',
  '☄ обстрел': '☄ bombard',
  '▼ выгрузка': '▼ unload',
  '⏸ 6ч': '⏸ 6h',
  '⏸ 12ч': '⏸ 12h',
  '⏸ 24ч': '⏸ 24h',
  '↩ последний': '↩ last',
  '↩ последний шаг убран': '↩ last step removed',
  '🔁 по кругу': '🔁 loop',
  ...
  '✖ план: не длиннее {n} шагов': '✖ plan: no more than {n} steps',
  ...
  '● СТРОЮ ПЛАН — тапайте миры · шагов: {n}{fleets}': '● BUILDING PLAN — tap worlds · steps: {n}{fleets}',
  ' · флотов: {n}': ' · fleets: {n}',
  '⚠ флот {id}: план прерван — {err}': '⚠ fleet {id}: plan halted — {err}',
  '«Строить» + тапы по мирам собирают план: переходы, «штурм», «обстрел», «погрузка»/«выгрузка», «ждать N ч». «🔁 по кругу» гоняет план до отмены (патруль). ✕ у шага правит план точечно; живой приказ (Move/Stop/штурм) снимает план целиком. Если шаг сорвался — план встаёт на паузу и ждёт вас, а не рушится молча.':
    '"Build" + taps on worlds assemble a plan: moves, "assault", "bombard", "load"/"unload", "wait N h". "🔁 loop" runs the plan until cancelled (patrol). ✕ on a step edits the plan surgically; a live order (Move/Stop/assault) drops the whole plan. If a step fails, the plan pauses and waits for you instead of silently breaking.',
