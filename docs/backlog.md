...
- **SES-2.3** ⏳ `[srv]` Окно входа: новое кресло — только 4 реальных дня от создания сессии.
- **SES-2.4** ⏳ `[proto]` Лента сессий в главном меню (места X/Y, игровой день, окно, статус).
