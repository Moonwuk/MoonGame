...
- **H3** ⏳ Предматчевый экран: выбор фракции / технологий. _(B1 ✅ — замок снят; частично покрыто: совет учёных выбирается перед матчем, стартовая позиция — на карте setup; фракция — ещё нет.)_
- **H4** ✅ Конструктор наземной армии (UI): внутриматчевая «Сборка дивизии» на карточке мира — 3 шаблона × 6 слотов (пехота/танк), редактирование слотов, превью «Влияние на характеристики» (атака/оборона/корпус) и мобилизация; синергии состава.
