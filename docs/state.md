...
> **Гейт:** `pnpm run check` (lint + typecheck + test). **Тесты: 1198 зелёных** (5 skip, 116 файлов).
...
дальше. Полный AvA-цикл (флаги готовности → вызов/принятие → ростер/фазы,
`corporation-wars.md`) — следующие кирпичи блока AVA.
